...
def test_user_cant_use_bad_words(author_client, news, form_data):
    """При попытке отправить комментарий, содержащий запрещенные слова,
    комментарий не будет опубликован, а форма вернет ошибку.
    """
    url = reverse('news:detail', args=(news.id,))
...
def test_user_cant_edit_comment_of_another_user(
    ...
    """Авторизованный пользователь не может отредактировать
    чужой комментарий.
    """
